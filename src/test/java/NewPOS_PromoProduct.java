...
public class NewPOS_PromoProduct extends BaseClass{
    ...
    public void TestNewPos(){
       ...
       /* contactCardStep.stepSendPhoto1("C:/ОТПБанк/фото1.png");
        ...
        pageCreditCircsStep.stepPromoProduct();
        pageCreditCircsStep.stepProductPromo();
        pageCreditCircsStep.stepSelectLifeInsurance();
        pageCreditCircsStep.stepWorkInsurance();
        pageCreditCircsStep.stepCreditTermPromo();
